...
var settings = {
  "url": "https://cms.istad.co/api/km-products?filters[id]=36&populate=*&pagination[pageSize]=1",
  "method": "GET",
  "timeout": 0,
};
...
const fetchData = async (page) => {
  try {
    const response = await $.ajax({
      url: `https://cms.istad.co/api/km-products?filters[type][name][$containsi]=Trending&populate=*&pagination%5Bpage%5D=${page}&pagination[pageSize]=3`,
      method: "GET",
    });
