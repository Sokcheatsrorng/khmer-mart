...
const renderCard = ({attributes
  ...
  return `
        ...
        <div class="w-full max-w-sm bg-white border border-white rounded-xl shadow-none">
            ...
            <a href="/src/flashsale.html">
                <img class="p-5 rounded-t-lg w-[400px] h-[200px] z-0" src="https://cms.istad.co${imageUrl}" alt="${imageName}" id="images"/>
            </a>
            <div class="px-5 pb-5">
                <a href="#" class="w-full">
  ...
  fetch("https://cms.istad.co/api/km-products?populate=*", requestOptions)
