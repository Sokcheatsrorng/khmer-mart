  ...
  return `
        ...
        <div class="w-full max-w-sm bg-white border border-white rounded-xl shadow-none">
            ...
            <a href="/src/flashsale.html">
                <img class="p-5 rounded-t-lg w-[400px] h-[200px] z-0" src="${images}" alt="food-discount" id="images"/>
            </a>
            <div class="px-5 pb-5">
                <a href="#" class="w-full">
                ...
                <div class="flex items-center mt-2.5 mb-5">
                    <div class="flex items-center space-x-1 rtl:space-x-reverse text-[#FF9E37] text-xl" id="stars">
                        ${stars}
                    </div>
                ...
                <div class="flex items-center justify-between gap-4">
                    ...
                    <span class="text-3xl font-inter text-gray-700"><del id="discPrice">$${discPrice} </del> </span>
...
// click addtoFav Button to store data in card to API
